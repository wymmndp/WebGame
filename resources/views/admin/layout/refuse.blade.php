                                                                    ...
                                                                    <tr>
                                                                        <td valign="middle" align="center">
                                                                            <div style="max-height:50px">
                                                                                <div>
                                                                                    <a><img align="none" alt="Addictinggames" border="0" hspace="0" src="https://www.addictinggames.com/sites/default/files/logo.png" style="display:block;margin:0px;height: auto" title="Addiciting Game" vspace="0"  class="CToWUd">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td width="560" align="center" style="font-family:arial,helvetica,sans-serif;font-size:16px;color:#313131;text-align:left;line-height:24px">
                                                                            <div style="text-align:center;line-height:24px">
                                                                                <span style="font-size:18px">
                                                                                    <strong>Hi {{$account->username}}</strong>
                                                                                </span>
                                                                                <br>
                                                                                Cảm ơn bạn đã up game của bạn lên web của chúng tôi<br><br>
                                                        ...
                                                        <td align="center">
                                                            <table width="540" border="0" cellspacing="0" cellpadding="0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <div style="font-family:Ariel,Helvetica,sans-serif;font-size:14px;color:#313131;text-align:center;line-height:26px;width:540px">
                                                                                Rất tiếc, game của bạn đã không được duyệt lên web của chúng tôi
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr height="20">
